    ...
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate="" action="{{route('admin.pages.notice.update',$notice->id)}}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label  class="section-title mt-0">Title *</label>
                                <input type="text" class="form-control" required name="title" value="{{$notice->title}}">
                        ...
                        <div class="form-group col-md-12">
                            <label  class="section-title mt-0">Body *</label>
                                <textarea  class="form-control" required name="body" style="height: 250px!important;"><?php echo str_replace("\\n","\n",$notice->body); ?></textarea>
                            <div class="invalid-feedback">
